...
class StringCompareRef implements Comparator<String> {
  public int compare(String p1, String p2) {
    return p1.compareTo(p2);
  }
}

class StringLengthCompareRef implements Comparator<String> {
...
class BooleanCompareRef implements Comparator<Boolean> {
...
class CompareListsRef {
  ...
  void testMerge(Tester t) {
    ...
    t.checkExpect(merge(new StringCompareRef(), strs1, strs2), result);

    List<String> empty = Arrays.asList();
    t.checkExpect(merge(new StringCompareRef(), strs1, empty), strs1);
    t.checkExpect(merge(new StringCompareRef(), empty, strs2), strs2);
